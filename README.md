...
My name is Ryan Wallace. I am a fullstack software engineer with a passion for designing and building scalable applications. My work is primarily in React/Redux/Node applications within the Flux design paradigm. I worked on an open source product - Recoilize - a chrome developer tool for visualizing and debugging applications that utilie Recoil.js for state management and contributed to Google's Tensorflow.js, implemententing pre-processing layers that dynamically adjust width and height of input data via random number generation to augment image training data. Most recently, I was a DSML Engineer for Codesmith where I had the opportunity to mentor junior engineers in software engineering best practices and develop course curriculum.
